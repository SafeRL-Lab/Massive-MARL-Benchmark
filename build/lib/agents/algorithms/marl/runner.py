...
from agents.algorithms.marl.utils.separated_buffer import SeparatedReplayBuffer
from agents.utils.util import update_linear_schedule
...
class Runner:
    ...
    def __init__(self,
        ...
        if self.algorithm_name == "happo":
            from agents.algorithms.marl.happo_trainer import HAPPO as TrainAlgo
            from agents.algorithms.marl.happo_policy import HAPPO_Policy as Policy
        if self.algorithm_name == "hatrpo":
            from agents.algorithms.marl.hatrpo_trainer import HATRPO as TrainAlgo
            from agents.algorithms.marl.hatrpo_policy import HATRPO_Policy as Policy
        if self.algorithm_name == "mappo":
            from agents.algorithms.marl.mappo_trainer import MAPPO as TrainAlgo
            from agents.algorithms.marl.mappo_policy import MAPPO_Policy as Policy
